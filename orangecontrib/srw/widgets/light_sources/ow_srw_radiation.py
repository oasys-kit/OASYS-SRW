...
class OWSRWRadiation(SRWWavefrontViewer):
    ...
    def __init__(self, show_automatic_box=False):
        ...
        tab_convolution = oasysgui.createTabPage(self.tabs_setting, "Intensity/Power Density")
    ...
    def getTitles(self, with_um=False):
        if with_um: return ["Intensity [ph/s/.1%bw/mm^2] vs E,X,Y", "Power Density []"]
        else: return ["Intensity", "Power Density"]
