...
class OWdabam_height_profile(OWWidget):
    ...
    usage_path = resources.package_dirname("orangecontrib.srw.widgets.gui") + "/misc/dabam_height_profile_usage.png"
    ...
    def generate_heigth_profile_file(self, not_interactive_mode=False):
        if not self.zz is None and not self.yy is None and not self.xx is None:
            try:
                ...
                SU.write_error_profile_file(self.zz, self.xx, self.yy, congruence.checkFileName(self.heigth_profile_file_name))
