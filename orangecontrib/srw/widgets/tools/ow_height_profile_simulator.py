...
from oasys.widgets.abstract.ow_abstract_height_profile_simulator import OWAbstractHeightErrorProfileSimulator
...
class OWheight_profile_simulator(OWAbstractHeightErrorProfileSimulator):
    ...
    def write_error_profile_file(self, zz, xx, yy, heigth_profile_file_name):
        SU.write_error_profile_file(zz, xx, yy, heigth_profile_file_name)
